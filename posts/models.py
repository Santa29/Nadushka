...
class Author(models.Model):
    ...
    firstname = models.CharField("Имя на английском с заглавной буквы", max_length=25)
    lastname = models.CharField("Фамилия на английском с заглавной буквы", max_length=40)
    thirdname = models.CharField("Отчество на английском с заглавной буквы", max_length=40)
